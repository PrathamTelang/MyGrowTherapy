...
function Connect() {
  return (
     <div className="min-h-screen sm:h-screen flex flex-col sm:flex-row bg-secondary pt-14">
 ...
 <div className='w-full flex justify-center items-center'>
    ...
    <Reveal className='w-full h-full sm:w-1/2 flex justify-center items-center'>
        <div className='bg-textcolor w-[80%]  flex flex-col justify-center items-center text-center p-10 rounded-lg text-white text-xl leading-relaxed'>
